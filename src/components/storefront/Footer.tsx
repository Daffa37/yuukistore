  ...
  return (
    <footer className="border-t border-gray-100 bg-white">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {/* Mengubah flex-col md:flex-row menjadi flex flex-col gap-8 */}
        <div className="flex flex-col gap-8 mb-6">
          ...
          {/* Link kolom (Produk & Bantuan) */}
          {/* Di layar HP (mobile) akan turun ke bawah, di layar PC akan sejajar ke kanan */}
          <div className="grid grid-cols-2 gap-8 md:gap-10 w-full md:w-2/3 md:justify-end">
            <div>
